...
import 'package:jpv_flutter/src/ui/person_search/details_page.dart';
...
class HomePersonSearch extends StatefulWidget {
  const HomePersonSearch({Key? key}) : super(key: key);

  @override
  State<HomePersonSearch> createState() => _HomePersonSearchState();
}
