...
class DetailsPageSearch extends StatefulWidget {
  DetailsPageSearch({Key? key}) : super(key: key);

  @override
  _DetailsPageSearchState createState() => _DetailsPageSearchState();
}

class _DetailsPageSearchState extends State<DetailsPageSearch> {

    final borderRadiusButton = BorderRadius.circular(10.0);
        final style = TextStyle(fontSize: 25.0, color: Color(0xff00111C), fontWeight: FontWeight.w800, letterSpacing: 1.0);
    final substyle = TextStyle(fontSize: 30.0, color: Colors.white, fontWeight: FontWeight.w300, letterSpacing: 2.0);
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.only(
          ...
          topRight: requests.efectocircular
              ...
              : Radius.circular(0),
          bottomLeft:
              requests.efectocircular ? Radius.circular(100) : Radius.circular(0),
          bottomRight:
              requests.efectocircular ? Radius.circular(100) : Radius.circular(0),
        ),
      ...
      child: requests.mostrar?
            ...
            ListView(
             ...
             SizedBox(height: MediaQuery.of(context).size.height *0.2,),
                ...
                ShakeTransition(
                  child: Text('Successful Result', style: TextStyle(fontSize: 20.0, color: Colors.white),)),
                SizedBox(height: 10,),
                ShakeTransition(
                    axis: Axis.vertical,
                    child: Text(
